...
class TestCharmConfigure(EllaUnitTestFixtures):
    def test_given_config_file_not_written_when_configure_then_config_file_is_written(
        ...
        with tempfile.NamedTemporaryFile() as local_file:
            ...
            state_in = testing.State(containers=[container], leader=True, relations=[peer_relation])
...
#                 db_relation.id: {"uris": "mongodb://localhost:27017/core"}
#             }
...
#                 {
#                     "summary": "core layer",
#                     "description": "pebble config layer for core",
#                     "services": {
#                         "core": {
#                             "summary": "core",
#                             "startup": "enabled",
...
#             can_connect=True,
#             mounts={
#                 "config": testing.Mount(location="/etc/core/core.yaml", source="/tmp/core.yaml")
#             },
#             execs={
#                 testing.Exec(
#                     command_prefix=["ip", "route", "show"],
...
#         self.mock_core.create_gnb.assert_called_once_with(name="gnb1", tac=1234)
...
#         self.mock_core.delete_gnb.assert_called_once_with(name="gnb1")
